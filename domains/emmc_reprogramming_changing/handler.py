...
vectorstore = FAISS.load_local("domains/emmc_reprogramming_changing/faiss_index", 
...
with open("domains/emmc_reprogramming_changing/prompt.txt", "r", encoding="utf-8") as f:
